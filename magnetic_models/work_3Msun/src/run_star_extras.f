...
! ***********************************************************************
      ...
      contains
        ...
        integer function how_many_extra_history_columns(id, id_extra)
           ...
           call star_ptr(id, s, ierr)
           if (ierr /= 0) return
           how_many_extra_history_columns = 76
        ...
        subroutine data_for_extra_history_columns(id, id_extra, n, names, vals, ierr)
           ...
           integer ::  sc1_bottom, sc2_bottom, sc3_bottom, sc4_bottom, col_count
  ...
  !        Pressure scale Heigths (0,1,2,3,4,5,6,7,8)
           ...
           names(73) = 'HI_B_shutoff_conv'
           vals(73) = HI_B_shutoff_conv 
           names(74) = 'HeI_B_shutoff_conv'
           vals(74) = HeI_B_shutoff_conv 
           names(75) = 'HeII_B_shutoff_conv'
           vals(75) = HeII_B_shutoff_conv 
           names(76) = 'FeCZ_B_shutoff_conv'
           vals(76) = FeCZ_B_shutoff_conv 
