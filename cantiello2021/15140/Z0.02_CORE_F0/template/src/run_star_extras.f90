...
! ***********************************************************************
      ...
      contains
           ...
           s% data_for_extra_profile_header_items => data_for_extra_profile_header_items
              ...
              subroutine get_convective_core(id, sc_convective_core,ierr)
                ...
                subroutine get_max_p_turb_over_p(id, ierr, p_turb_over_p, sc_top, sc_bottom)
                   ...
                   p_turb_over_p =  MAXVAL((1d0/3d0) * s%rho(sc_top:sc_bottom) * pow(s% conv_vel(sc_top:sc_bottom),2)/EXP(s% lnP(sc_top:sc_bottom)))
        ...
        integer function how_many_extra_history_columns(id)
           ...
           call star_ptr(id, s, ierr)
           if (ierr /= 0) return
           how_many_extra_history_columns = 108
                ...
                subroutine data_for_extra_history_columns(id, n, names, vals, ierr)
                   ...
                   real(dp) :: F0
                   real(dp) :: HI_p_turb_over_p, HeI_p_turb_over_p, HeII_p_turb_over_p, FeCZ_p_turb_over_p
